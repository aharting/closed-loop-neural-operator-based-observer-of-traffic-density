...
class Sequential(FNN2d):
    def __init__(self, ic_model, 
                 modes1, modes2, deltaT, T_out, device,
                 width=64, fc_dim=128,
                 layers=None,
                 activation='gelu',
                 output_activation=None):
        super(Sequential, self).__init__(modes1=modes1, 
                                         modes2=modes2,
                                         width=width, 
                                         fc_dim=fc_dim,
                                         layers=layers, 
...
class Correction(FNN2d):
    def __init__(self, ic_model, 
                 ...
                 activation='gelu',
                 output_activation=None):
        super(Correction, self).__init__(modes1=modes1, 
                                         modes2=modes2,
                                         width=width, 
                                         fc_dim=fc_dim,
                                         layers=layers, 
